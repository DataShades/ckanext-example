...
vendor-dir = ckanext/example/assets/vendor
...
vendor:  ## Copy vendor libraries from node_modules/ to assets directory
	...
	cp node_modules/slick-carousel/slick/ajax-loader.gif ckanext/example/public
	cp node_modules/slick-carousel/slick/fonts ckanext/example/public/slick-fonts -r
	cp node_modules/daterangepicker/daterangepicker.{js,css} ckanext/example/assets/vendor
	cp node_modules/daterangepicker/moment.min.js ckanext/example/assets/vendor
	cp node_modules/overlayscrollbars/styles/overlayscrollbars.css ckanext/example/assets/vendor
	cp node_modules/overlayscrollbars/browser/overlayscrollbars.browser.es6.js ckanext/example/assets/vendor/overlayscrollbars.js
