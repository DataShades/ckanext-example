...
from ckanext.example.model import Something
...
def example_get_sum(context: Context, data_dict: dict[str, Any]):
    ...
    Returns:
        operation details
    """
    tk.check_access("example_get_sum", context, data_dict)
...
def example_something_create(context: Context, data_dict: dict[str, Any]):
    ...
    """
    tk.check_access("example_something_create", context, data_dict)
