...
`ckanext.example.views` and re-export via `__all__`.
...
@bp.route("/example/page")
def page():
    """Basic page."""
    return "Hello, example!"


@bp.route("/example/page-redirect")
def page_redirect():
    """Complex page."""
    return tk.redirect_to("example.page")
...
class ComplexView(MethodView):
    ...
    def post(self, word: str):
        ...
        try:
            result = tk.get_action("example_get_sum")(
                {},
                params,
            )
